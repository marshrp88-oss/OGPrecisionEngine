  ...
  for (const b of allBills) {
    ...
    if (nextState === "scheduled") {
      if (b.autopay && b.dueDay <= dayOfMonth) {
        ...
        nextPaidDate = d.toISOString().split("T")[0];
        nextKey = ck;
